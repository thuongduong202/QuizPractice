...
$(document).on('click', '#removeinnerQuestion', function () {
    ...
    var titleQuiz = document.getElementById("titleQuiz").value;
...
let i= document.getElementById('NumberOfQuestion').value-1;
console.log(i)
let o=1;
//add option
...
//    console.log(string);
    ...
    var html1 = '';
    html1 += `<div id="question${id}_${o}new" class="innerQuestion${id}">
                                                                                    <div>
                                                                                        <div>
                                                                                    ...
                                                                                    <div class="td-form-item" >
                                                                                        <div class="form-item-wrap">
                                                                                            ...
                                                                                            <div class="form-item form-checkbox checkbox-style">
                                                                                                <input type="checkbox" id='newque${id}_option${o}' name="right_option${id}" class="right_option${id}" value="ON" >
                                                                                                <label for="newque${id}_option${o}">
                                                                                                    <i style="width:30px;height: 30px; margin-top: 15px;" class="icon-checkbox icon md-check-1"></i>
                                                                                                </label>
                                                                                            </div>
                                                                                            <div class="course-region-tool">
                                                                                                <button style="width:30px;height: 30px;font-size: 30px; margin-top: 12px;" class="delete" type="button" id='removeinnerQuestion${id}' onclick="removeOption('question${id}_${o}new')" title="delete"><i class="icon md-recycle"></i></button>
                                                                                            </div>
                                                                                        </div>
                                                                    ...
                                                                    <div class="tb-course">
                                                                        <div>
                                                                            ...
                                                                            <div id='createOption${i}'>
                                                                                <div id='question${i}_${o}new' class="innerQuestion${i}">
                                                                                    <div>
                                                                                        <div>
                                                                                            <label for="option">Option <span><p class="optionnumber${i}"> 1</p></span></label>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="td-form-item" >
                                                                                        <div class="form-item-wrap">
                                                                                            ...
                                                                                            <div class="form-item form-checkbox checkbox-style">
                                                                                                <input type="checkbox" id='new_que${i}_option${o}' name="right_option${i}" class="right_option${i}" value="ON" >
                                                                                                <label for="new_que${i}_option${o}">
                                                                                                    <i style="width:30px;height: 30px; margin-top: 15px;" class="icon-checkbox icon md-check-1"></i>
                                                                                                </label>
                                                                                            </div>
                                                                                            <div class="course-region-tool">
                                                                                                <button style="width:30px;height: 30px;font-size: 30px; margin-top: 12px;" class="delete" type="button" id='removeinnerQuestion' onclick="removeOption('question${i}_${o}new')" title="delete"><i class="icon md-recycle"></i></button>
                                                                                            </div>
                                                                                        </div>
                                                                            ...
                                                                            <div class="form-item form-checkbox checkbox-style" style="margin-top: 10px;">
                                                                                                <input type="checkbox" checked id='randomOption${i}' name="randomOption${i}" class="randomOption" value="on">
