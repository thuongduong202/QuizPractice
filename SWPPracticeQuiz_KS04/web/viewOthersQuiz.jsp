                ...
                <section class="sub-banner section">
                    ...
                    <div class="container">
                        <div class="info-author">
                            <div class="image">
                            <c:if test="${oUser.avatar==null}">
                                <img src="imageUpload/default-avatar.png" alt="avatar">
                            </c:if>
                            <c:if test="${oUser.avatar!=null}">
                                <img src="imageUpload/${oUser.avatar}" alt="avatar">
                            </c:if>
                        </div>    
                        <div class="name-author">
                            <h2 class="big">${oUser.userName}</h2>
                        </div>     
                        ...
                        <div class="col-md-9 col-md-push-3">
                            <div class="content grid">
                                <div class="row">
                                        ...
                                        <nav aria-label="...">
                                            <c:if test="${endPage>=2}">
                                                <ul class="pagination">
                                                    <c:if test="${index != 1}">
                                                        <li class="page-item">
                                                            <a class="page-link" href="ViewOtherQuizController?index=${index-1}&categoryId=${requestScope.categoryId}&txtSearch=${txtSearch}&userid=${userid}">Previous</a>
                                                        </li>
                                                    </c:if>
                                                    <c:forEach begin="1" end ="${endPage}" var="i">
                                                        <li class="page-item  ${index==i?"active":""}" aria-current="page">
                                                            <a class="page-link" href="ViewOtherQuizController?index=${i}&categoryId=${requestScope.categoryId}&txtSearch=${txtSearch}&userid=${userid}">${i}</a>
                                                        </li>
                                                    </c:forEach>
                                                    <c:if test="${index != endPage}">
                                                        <li class="page-item">
                                                            <a class="page-link" href="ViewOtherQuizController?index=${index+1}&categoryId=${requestScope.categoryId}&txtSearch=${txtSearch}&userid=${userid}">Next</a>
                                                        </li>
                                                    </c:if>
                                                </ul>
                                            </c:if>
                                    ...
                                    <div class="col-md-6" style="margin-top: 16px; padding: 8px 16px;" >
                                        <form action="ViewOtherQuizController" method="POST">
                                            <input type="text" name="userid" value="${userid}" hidden="">
                                            <input type="text" name="categoryId" value="${requestScope.categotyId}" hidden="">
                                            ...
                                            <div class="col-sm-6 col-md-4">
                                                <div class="mc-item mc-item-2" style="">
                                                    ...
                                                    <!--                                                    <div class="content-item">
                                                                                                            <a href="EditQuizController?quizid=${x.quizid}"><i style="color: black;" class="icon md-pencil"></i></a>
                                                                                                            <a href="#"><i style="color: black;"class="icon md-recycle"></i></a>
                                                                                                        </div>-->
                                                    ...
                                                    <div style="align-content: center;">
                                                        <!-- HTML !-->
                                                        <a href="ViewQuizDetailController?quizid=${x.quizid}&userid=${userid}"><button class="button-66" role="button">View Quiz</button></a>
                                ...
                                <div class="inner">
                                    ...
                                    <div class="widget">
                                        <ul class="list-style-block">
                                            <li><a href="ViewOtherQuizController?userid=${userid}" <c:if test="${requestScope.categoryId == null || requestScope.categoryId eq ''}"> style="color: blue;" </c:if> 
                                                   >All Quiz</a></li>
                                                <c:forEach items = "${listC}" var = "o">
                                                <li><a href="ViewOtherQuizController?categoryId=${o.categoryId}&userid=${userid}"
